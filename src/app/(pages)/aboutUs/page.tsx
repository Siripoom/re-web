      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto py-12 px-4">
            ...
            <Row justify="center" gutter={[32, 32]} className="mt-10">
              <Col xs={24} md={8}>
                <Card className="team-card" hoverable>
                  ...
                  <Paragraph type="secondary">{t("aboutTeamCEODesc")}</Paragraph>
                </Card>
              </Col>
              <Col xs={24} md={8}>
                <Card className="team-card" hoverable>
                  ...
                  <Paragraph type="secondary">{t("aboutTeamSalesDesc")}</Paragraph>
                </Card>
              </Col>
            </Row>
          </section>
          ...
          <section>
            ...
            <Paragraph className="text-center max-w-3xl mx-auto" style={{
              animation: 'fadeInLuxury 1.2s cubic-bezier(0.19, 1, 0.22, 1) forwards',
              opacity: 0,
              animationDelay: '0.5s'
            }}>
